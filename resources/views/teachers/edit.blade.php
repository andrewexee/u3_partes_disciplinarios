...
<div class="page-header">
    <div>
        ...
        <div class="breadcrumb"><a href="{{ route('teachers.index') }}">Profesores</a> / {{ $teacher->nombre_completo }}</div>
    </div>
</div>
...
<div class="card" style="max-width:680px">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('teachers.update', $teacher) }}">
            ...
            <div style="background:#f9f8f4;border:1px solid var(--border);border-radius:var(--radius);
                        padding:1rem;margin-bottom:1.25rem;font-size:.85rem;color:var(--muted)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre"
                           ...
                           value="{{ old('nombre', $teacher->nombre) }}"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="apellidos"
                           ...
                           value="{{ old('apellidos', $teacher->apellidos) }}"
                           required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="especialidad"
                       class="form-control"
                       value="{{ old('especialidad', $teacher->especialidad) }}"
